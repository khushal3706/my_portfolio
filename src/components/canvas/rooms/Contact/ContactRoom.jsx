    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="GITHUB"
                onClick={() => window.open('https://github.com/khushal3706', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="LINKEDIN"
                onClick={() => window.open('https://linkedin.com/in/sutharkhushal', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* TWITTER */}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.location.href = 'mailto:sutharkhushal1000@gmail.com'}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
